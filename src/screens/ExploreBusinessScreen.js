...
import { getAllBusinessApiCall } from '../store/getAllBusiness-slice'
...
export default ExploreBusinessScreen = ({ navigation }) => {
    ...
    const businessList = useSelector((state) => state.getAllBusiness.getAllBusinessDetails)
    ...
    const getAllUsersFunction = () => {
        dispatch(getAllBusinessApiCall())
    ...
    return (
        <View style={{ flex: 1 }}>
            {
                businessList.data === undefined ? <View style={{ height: heightToDp('60%'), width: widthToDp('100%'), justifyContent: 'center' }}>
                                        ...
                                        <View
                                            ...
                                            >
                                                <Image
                                                    ...
                                                    style={{ height: heightToDp('15%'), width: widthToDp('30%'), borderRadius: 20, marginTop: heightToDp('0%'), marginLeft: widthToDp('2%') }}
                                                />
                                            </TouchableOpacity>
                                            <View style={{ height: heightToDp('20%'), width: widthToDp('50%'), marginLeft: widthToDp('2%'), marginTop: heightToDp('6%') }}>
                                                ...
                                                >
                                                    <Text style={{ color: 'black', fontWeight: 'bold', fontSize: heightToDp('2.5%') }}>{item.name}</Text>
                                                ...
                                                <View style={{ borderWidth: 1, borderColor: '#a0b1e1', height: heightToDp('3%'), width: widthToDp('42%'), borderRadius: 300, justifyContent: 'center', alignItems: 'center' }}>
                                                    <Text style={{ color: 'black', fontWeight: 'bold' }}>{item.productCategory} {item.natureOfBusiness}</Text>
                                                </View>
                                                <TouchableOpacity
                                                    ...
                                                    />
                                                    <DistanceCalculationComponent lat2={item.gpsAddress.latitude} lon2={item.gpsAddress.longitude} />
